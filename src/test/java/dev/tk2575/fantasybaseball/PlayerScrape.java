...
public class PlayerScrape {
	...
	public void getAllLeagueFreeAgentAdds() {
		...
		headers.add("Referer", "http://fantasy.espn.com/baseball/recentactivity?leagueId=30710&endDate=20190729&seasonId=2019&startDate=20190727&teamId=-1&transactionType=2&activityType=2&page=1");
		...
		try {
			...
			ResponseEntity<Topics> responseEntity = restTemplate.exchange("https://fantasy.espn.com/apis/v3/games/flb/seasons/2019/segments/0/leagues/30710/communication/?view=kona_league_communication", HttpMethod.GET, entity, Topics.class);
			...
			body.getTopics().stream().forEach(topic -> {
				...
				String url = String.format("https://fantasy.espn.com/apis/v3/games/flb/seasons/2019/players/%s?scoringPeriodId=0&view=players_wl", message.getTargetId());
				try {
